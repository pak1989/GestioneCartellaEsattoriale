...
/**
 * Servlet implementation class PrepareModificaContribuenteServlet
 */
...
public class PrepareModificaContribuenteServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		Contribuente contribuenteDaModificare = contribuenteService.caricaSingoloContribuente(idContribuente);
