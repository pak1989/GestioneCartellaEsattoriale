...
public class ExecuteEliminaContribuenteServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		contribuenteService
				.rimuovi(contribuenteService.caricaSingoloContribuenteConCartelleEsattoriali(idContribuente));

		RequestDispatcher rd = request.getRequestDispatcher("PrepareSearchContribuenteServlet");
