   ...
   <%@ include file="../header.jsp" %>
    ...
    <div class="page-header">
	  <h3>Pagina di Ricerca Utente</h3>
      	...
      	<form id="form" class="form-horizontal" action="ExecuteSearchUtenteServlet" method="post">
			...
			<div class="form-group">
		      ...
		      <div class="col-sm-offset-2 col-sm-10">
		        ...
		        <a href="PrepareInsertUtenteServlet" class="btn btn-primary btn-md">Inserisci Nuovo Utente</a>
		      </div>
		    </div>
		</form>
